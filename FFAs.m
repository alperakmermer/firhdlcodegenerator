...
%Filter Outputs                           
y_1 = conv (x0,h0);                  %(6 mul + 5 add) * 506               
y_2 = conv (x0px1, h0ph1);           %(6 mul + 5 add) * 506 
y_3 = conv (x1,h1);                  %(6 mul + 5 add) * 506 

%Delay
y_3_delayed = delayseq(y_3,1) ;

%Outputs
y0 = y_1 + y_3_delayed;             %1 * 506 add
y1 = y_2 - y_1 - y_3;               %1 * 506 add + 1 * 506 add
                                    %(18 mul)*506 + (18 add)*506 + 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
