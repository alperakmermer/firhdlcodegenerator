...
clear mlhdlc_2_phase48_tap_filter;
...
for ii=1:len
    ...
    [y0(ii),y1(ii)] = mlhdlc_2_phase_symmetric_48_tap_filter(x0(ii),x1(ii),h(1),h(2),h(3),h(4),h(5),h(6),h(7),h(8),h(9),h(10),h(11),h(12),h(13),h(14),h(15),h(16),h(17),h(18),h(19),h(20),h(21),h(22),h(23),h(24));
end
